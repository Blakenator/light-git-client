...
var url = require("url");
var fs = require("fs");
var SettingsModel_1 = require("./shared/SettingsModel");
...
function loadSettings(callback) {
    if (fs.existsSync(getSettingsPath())) {
        fs.readFile(getSettingsPath(), 'utf8', function (err, data) {
            if (err) {
                throw err;
            }
            callback(Object.assign(new SettingsModel_1.SettingsModel(), JSON.parse(data)));
        });
    }
    else {
        var settingsModel = new SettingsModel_1.SettingsModel();
...
function loadRepoInfo(repoPath, callback) {
    git.Repository.open(repoPath).then(function (repo) {
        var promises = [];
        var info = new Repository_model_1.RepositoryModel();
        info.name = path.dirname(repoPath);
        info.path = repoPath;
        promises.push(repo.getRemotes().then(function (remotes) { return info.remotes = remotes; }));
        promises.push(repo.getReferences(3 /* LISTALL */).then(function (branches) {
            info.localBranches = branches.filter(function (x) { return x.isBranch() && !x.isRemote(); }).map(function (x) {
                var branchModel = new Branch_model_1.BranchModel();
                branchModel.name = x.name();
                branchModel.reference = x;
                return branchModel;
            });
            info.remoteBranches = branches.filter(function (x) { return x.isBranch() && x.isRemote(); }).map(function (x) {
                var branchModel = new Branch_model_1.BranchModel();
                branchModel.name = x.name();
                branchModel.reference = x;
                return branchModel;
...
try {
    ...
    electron_1.ipcMain.on('openUrl', function (event, args) {
        var url = args[1];
        if (args.length > 2) {
            opn(url, { app: args[2] });
        }
    ...
    electron_1.ipcMain.on('openFolder', function (event, args) {
        var url = args[1];
        electron_1.shell.openItem(url);
        defaultReply(event, args);
    });
    electron_1.ipcMain.on('loadSettings', function (event, args) {
        loadSettings(function (settings) {
            event.sender.send(getReplyChannel(args), settings);
        });
        if (!isWatchingSettingsDir) {
            isWatchingSettingsDir = fs.watch(getSettingsPath(), function (eventInfo, filename) {
                loadSettings(function (settings) {
    ...
    electron_1.ipcMain.on('saveSettings', function (event, args) {
        saveSettings(args[1]);
        defaultReply(event, args);
    });
    electron_1.ipcMain.on('loadRepo', function (event, args) {
        loadRepoInfo("C:/Users/blake/Documents/projects/material-steam", function (repo) {
...
},{"./shared/Branch.model":undefined,"./shared/Repository.model":undefined,"./shared/SettingsModel":undefined,"electron":12,"electron-reload":4,"electron-updater":11,"fs":undefined,"nodegit":17,"opn":19,"path":undefined,"url":undefined}],2:[function(require,module,exports){
...
},{"./CancellationToken":undefined,"./ProgressCallbackTransform":undefined,"./httpExecutor":undefined,"./publishOptions":undefined,"./rfc2253Parser":undefined,"./uuid":undefined,"./xml":undefined}],4:[function(require,module,exports){
...
},{"child_process":undefined,"chokidar":6,"electron":12,"fs":undefined,"path":undefined}],5:[function(require,module,exports){
'use strict';
...
},{"micromatch":10,"normalize-path":18,"path":undefined}],6:[function(require,module,exports){
'use strict';
...
},{"./lib/fsevents-handler":undefined,"./lib/nodefs-handler":undefined,"anymatch":5,"async-each":2,"events":undefined,"fs":undefined,"glob-parent":7,"inherits":13,"is-glob":9,"path":undefined,"path-is-absolute":20}],7:[function(require,module,exports){
'use strict';
...
},{"is-glob":9,"path":undefined}],8:[function(require,module,exports){
/*!
...
},{"is-extglob":8}],10:[function(require,module,exports){
/*!
...
},{"./lib/expand":undefined,"./lib/utils":undefined}],11:[function(require,module,exports){
"use strict";
...
},{"./AppImageUpdater":undefined,"./AppUpdater":undefined,"./MacUpdater":undefined,"./NsisUpdater":undefined,"./Provider":undefined,"builder-util-runtime":3,"url":undefined}],12:[function(require,module,exports){
var fs = require('fs')
var path = require('path')
...
},{"./inherits_browser.js":undefined,"util":undefined}],14:[function(require,module,exports){
'use strict';
const os = require('os');
const fs = require('fs');
...
},{"fs":undefined,"os":undefined}],15:[function(require,module,exports){
(function (global){
/**
 * @license
...
},{"./lib":undefined}],17:[function(require,module,exports){
"use strict";
...
},{"../build/Debug/nodegit.node":undefined,"../build/Release/nodegit.node":undefined,"../package":undefined,"./enums.js":undefined,"./status_file":undefined,"./utils/lookup_wrapper":undefined,"./utils/normalize_fetch_options":undefined,"./utils/normalize_options":undefined,"./utils/shallow_clone":undefined,"lodash":15,"promisify-node":21}],18:[function(require,module,exports){
/*!
...
},{"remove-trailing-separator":22}],19:[function(require,module,exports){
'use strict';
const path = require('path');
...
},{"child_process":undefined,"is-wsl":14,"path":undefined}],20:[function(require,module,exports){
'use strict';
...
},{"./utils/args":undefined,"nodegit-promise":16}],22:[function(require,module,exports){
